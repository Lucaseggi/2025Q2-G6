...
if not exist "terraform\lambda-artifacts" mkdir terraform\lambda-artifacts
copy 06-relational-guard\target\relational-guard-1.0.0.jar terraform\lambda-artifacts\
...
copy 07-vectorial-guard\target\vectorial-guard-1.0.0.jar terraform\lambda-artifacts\
