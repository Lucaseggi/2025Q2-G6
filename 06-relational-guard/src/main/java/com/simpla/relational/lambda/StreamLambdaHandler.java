package com.simpla.relational.lambda;
...
import com.simpla.relational.RelationalApplication;
...
public class StreamLambdaHandler implements RequestStreamHandler {
    ...
    static {
        try {
            ...
            handler = SpringBootLambdaContainerHandler.getAwsProxyHandler(RelationalApplication.class);
